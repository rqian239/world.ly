...
query_string = 'SELECT education.code, education.entity, education.percentage percentage_with_tertiary_education, income.gross_national_income per_capita_income FROM ShareOfThePopulationWithCompletedTertiaryEducation education, GrossNationalIncomePerCapita income WHERE education.code = income.code AND education.year = income.year AND education.year = \'2010\' '
