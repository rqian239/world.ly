...
def app_page(app: dash.Dash):
    ...
    world_map_fig_2_metrics_second = px.scatter_geo(df_map_2, locations = 'CODE',
                        animation_frame='YEAR',
                        animation_group='ENTITY',
                        color='ENTITY',
                        hover_name='ENTITY',
    ...
    layout = html.Div([nav, scatter_plot_section, world_map_section, world_map_2_metrics_section, world_map_fig_2_metrics_second_section, ftr], className="make-footer-stick")
    return layout